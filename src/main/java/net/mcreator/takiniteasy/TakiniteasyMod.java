package net.mcreator.takiniteasy;
...
@Mod("takiniteasy")
public class TakiniteasyMod {
	public static final Logger LOGGER = LogManager.getLogger(TakiniteasyMod.class);
	public static final String MODID = "takiniteasy";

	public TakiniteasyMod(IEventBus modEventBus) {
